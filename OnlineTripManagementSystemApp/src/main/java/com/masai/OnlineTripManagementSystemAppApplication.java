...
@EnableSwagger2
public class OnlineTripManagementSystemAppApplication {

	public static void main(String[] args) {
		SpringApplication.run(OnlineTripManagementSystemAppApplication.class, args);
	}
	...
	private ApiInfo apiDetails() {
		return new ApiInfo("Online Trip Management System", "Sample api", "1.0", "Freee",
